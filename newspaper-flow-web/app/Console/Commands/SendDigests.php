 ...
 *
 *   php artisan newspaperflow:digest --due     # scheduled
 *   php artisan newspaperflow:digest --user=7  # one user, ignoring schedule
 */
class SendDigests extends Command
{
    protected $signature = 'newspaperflow:digest
