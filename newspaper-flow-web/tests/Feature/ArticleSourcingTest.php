...
class ArticleSourcingTest extends TestCase
{
    ...
    {
        config()->set('newspaperflow.sources.thenewsapi.key', null);
        config()->set('newspaperflow.sources.newsdata.key', null);
        config()->set('newspaperflow.sources.gnews.key', null);
        config()->set('newspaperflow.sources.newsapi.key', null);
    ...
    {
        config()->set('newspaperflow.sources.google_news.enabled', true);
        config()->set('newspaperflow.signals.hacker_news', false);
...
XML;
    ...
    public function test_merges_same_story_across_sources_preferring_direct_url(): void
    {
        ...
        config()->set('newspaperflow.sources.thenewsapi.key', 'k1');
        config()->set('newspaperflow.sources.gnews.key', 'k2');
        config()->set('newspaperflow.signals.hacker_news', false);
    ...
    {
        config()->set('newspaperflow.sources.thenewsapi.key', 'test-key');
        config()->set('newspaperflow.signals.hacker_news', true);
