...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:url" content="https://newsroomflow.app{{ request()->getPathInfo() }}">
        <meta property="og:image" content="https://newsroomflow.app/img/og-default.png">
        ...
        <meta name="twitter:image" content="https://newsroomflow.app/img/og-default.png">
