...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="{{ $share->image_url ?: 'https://newsroomflow.app/img/og-default.png' }}">
        ...
        <meta name="twitter:image" content="{{ $share->image_url ?: 'https://newsroomflow.app/img/og-default.png' }}">
