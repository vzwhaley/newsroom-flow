...
|
*/
Schedule::command('newsroomflow:refresh --due')
    ->hourly()
    ->withoutOverlapping()
    ->runInBackground()
...
|
*/
Schedule::command('newsroomflow:refresh')
...
*/
Schedule::command('newsroomflow:digest --due')
    ->hourlyAt(5)
    ->withoutOverlapping()
    ->runInBackground()
...
*/
Schedule::command('newsroomflow:push --due')
    ->hourlyAt(7)
    ->withoutOverlapping()
    ->runInBackground()
...
|
*/
Schedule::command('newsroomflow:discover-sources --reverify --queue --limit=50')
    ->dailyAt('03:20')
    ->withoutOverlapping()
    ->runInBackground()
