...
return [
    ...
    */
    ...
    'provider' => env('NEWSROOMFLOW_PROVIDER', 'hybrid'),
    ...
    */
    ...
    'sources' => [
        ...
        // test suite via NEWSROOMFLOW_GOOGLE_NEWS=false so tests stay network-free.
        'google_news' => [
            'enabled'  => (bool) env('NEWSROOMFLOW_GOOGLE_NEWS', true),
    ...
    */
    ...
    'signals' => [
        ...
        'reddit'      => env('NEWSROOMFLOW_SIGNAL_REDDIT', false),
    ],
    ...
    */
    ...
    'llm' => [
        ...
        'model'   => env('NEWSROOMFLOW_LLM_MODEL', 'claude-haiku-4-5-20251001'),
    ...
    */
    ...
    'areas' => [
        ...
        'zip_geocoder' => env('NEWSROOMFLOW_ZIP_GEOCODER', 'https://api.zippopotam.us'),
    ],
    ...
    */
    ...
    'discovery' => [
        'enabled' => (bool) env('NEWSROOMFLOW_DISCOVERY', true) && (bool) env('ANTHROPIC_API_KEY'),
        ...
        'model'         => env('NEWSROOMFLOW_DISCOVERY_MODEL', 'claude-sonnet-5'),
        'max_searches'  => (int) env('NEWSROOMFLOW_DISCOVERY_MAX_SEARCHES', 5),
        'max_domains'   => (int) env('NEWSROOMFLOW_DISCOVERY_MAX_DOMAINS', 6),

        // Learned records re-verify after this many days (outlets rebrand/merge).
        'reverify_days' => (int) env('NEWSROOMFLOW_DISCOVERY_REVERIFY_DAYS', 120),
        ...
        'validate_liveness' => (bool) env('NEWSROOMFLOW_DISCOVERY_VALIDATE', true),

        // Anthropic server-side web search tool identifier.
        'web_search_tool' => env('NEWSROOMFLOW_DISCOVERY_TOOL', 'web_search_20250305'),
    ],
];
