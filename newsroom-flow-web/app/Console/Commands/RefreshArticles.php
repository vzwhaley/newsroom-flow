 ...
 *
 *   php artisan newsroomflow:refresh                 # every topic (manual/full)
 *   php artisan newsroomflow:refresh --due           # only topics whose owner's
 *                                                # local hour == now (scheduled)
 *   php artisan newsroomflow:refresh --topic=42      # one topic by id
 *   php artisan newsroomflow:refresh --user=7        # all of one user's topics
 *
...
{
    protected $signature = 'newsroomflow:refresh
