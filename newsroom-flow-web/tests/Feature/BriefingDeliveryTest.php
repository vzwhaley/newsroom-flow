...
class BriefingDeliveryTest extends TestCase
{
    ...
    {
        config()->set('newsroomflow.llm.enabled', false); // deterministic fallback text
        ...
        $this->artisan('newsroomflow:push --user='.$user->id)->assertSuccessful();
    ...
    public function test_pro_digest_email_opens_with_the_briefing(): void
    {
        ...
        $this->artisan('newsroomflow:digest --user='.$user->id)->assertSuccessful();
