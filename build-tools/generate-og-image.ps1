...
.DESCRIPTION
    ...
    Edge). Output: newsroom-flow-web/public/img/og-default.png — referenced by
...
<!doctype html><html><head><meta charset="utf-8"><style>
  ...
  .wm{font-size:108px;font-weight:700;letter-spacing:-1px;margin-top:14px;line-height:1}
  .wm .f{color:#bfdbfe}
  .tm{font-size:34px;vertical-align:super}
  .tag{font-size:38px;color:#e0e7ff;margin-top:10px;font-family:Arial,Helvetica,sans-serif}
  .by{position:absolute;bottom:36px;font-size:22px;color:#bfdbfe;font-family:Arial,Helvetica,sans-serif}
</style></head><body>
  <div class="card">
    $icon
    <div class="wm">News<span class="f">Flow</span><span class="tm">&#8482;</span></div>
    <div class="tag">Your own customized news topics, every day.</div>
    <div class="by">by moon whale media, llc</div>
  </div>
</body></html>
"@
