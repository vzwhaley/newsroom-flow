...
/// URLSession-backed client for the NewsroomFlow JSON API. Mirrors the Android
/// Retrofit `NewsroomFlowApi` interface method-for-method. Every authenticated
