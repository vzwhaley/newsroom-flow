...
Served locally by Herd at **https://newsflow.test**.
...
- `free@newsflow.test` — Free (2 topics)
- `pro@newsflow.test` — Pro Lifetime (unlimited)
...
```
* * * * * cd /path/to/newsflow-web && php artisan schedule:run >> /dev/null 2>&1
```
