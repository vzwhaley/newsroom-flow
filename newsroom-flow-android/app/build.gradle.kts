...
android {
    namespace = "com.newsroomflow.android"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.newsroomflow.android"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"

        buildConfigField("String", "DEFAULT_API_BASE_URL", "\"https://newsroomflow.app\"")
    ...
    buildTypes {
        debug {
            ...
            // `php artisan serve` (the newsroom-flow-web app). A physical
