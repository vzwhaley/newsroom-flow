...
- minSdk 26 · target/compileSdk 35 · package `com.newsroomflow.android`

## Architecture

```
com.newsroomflow.android/
...
Open the `newsroom-flow-android/` folder in Android Studio and Run, or from the CLI
